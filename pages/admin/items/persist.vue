<template>
  <v-container>
    ...
    <v-btn outlined v-if="!item.id" @click="persist()"> Cadastrar </v-btn>
    <v-btn outlined v-if="item.id" @click="persist()"> Atualizar </v-btn>
    <v-btn outlined to="/items"> Cancelar </v-btn>
  </v-container>
</template>
