      ...
      <v-container>
        ...
        >
          ...
          <v-container v-if="paymentSelect == 1">
              <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRbY4C7vOnXTpdAFv5y39_85xDAySznrfO9CQ&usqp=CAU" alt="">
            <br>
            <v-btn
              @click="pagando = true"
            >
            ...
            <v-btn
              color="red"
              @click="paymentSelect = false; pagando = false"
            >
            Escolher novamente
            </v-btn>
          </v-container>
            ...
            <template>
              ...
              >
                ...
                >
                 ...
                 <v-btn
                      @click="pagando = !pagando"
                    >
                        <v-progress-circular v-if="pagando"
                          indeterminate
                          color="primary"
                        ></v-progress-circular>
                      Confirmar dados
